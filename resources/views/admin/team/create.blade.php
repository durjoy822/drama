...
<style>
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add team form</h4>
                    ...
                    <form class="form-horizontal" action="{{route('teams.store')}}" method="POST" enctype="multipart/form-data">
                         ...
                         <div class="row mb-3 justify-content-end">
                            ...
                            <div class="col-md-9">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="member_type" id="inlineRadio1" value="1">
                                    <label class="form-check-label" for="inlineRadio1">Founder</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="member_type" id="inlineRadio2" value="2">
                                    <label class="form-check-label" for="inlineRadio2">Primary Member</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="member_type" id="inlineRadio2" value="3">
                                    <label class="form-check-label" for="inlineRadio2">Permanent Member</label>
                                </div>

                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio"  name="member_type" id="inlineRadio3" value="4">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="twitter" id="inputEmail32" placeholder="Twitter link"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail33" class="col-md-3 col-form-label">Facebook Link</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="facebook" id="inputEmail33" placeholder="Facebook link"/>
                            </div>
                        </div>
                        <div class="row mb-3">
                            <label for="inputEmail33" class="col-md-3 col-form-label">Instagram Link</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" name="instagram" id="inputEmail33" placeholder="Instagram link"/>
                            </div>
                        </div>
