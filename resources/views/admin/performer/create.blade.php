        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="header-title">Add performer form</h4>
                    <p class="text-muted font-14">{{Session::get('message')}}</p>
                    <form class="form-horizontal" action="{{route('performers.store')}}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td class="p-1">
                                    <input class="form-control" type="text" name="performer[0][name]" placeholder="Performer name" >
                                    <div class="text-danger">@error("performer.0.name") {{ $message }} @enderror</div>
                                </td>
                                <td class="p-1">
                                    <input class="form-control" type="text" name="performer[0][character]" placeholder="Performer Character " >
